...
import { kt_jx_upload_question_ing, kt_jx_upload_question_done, kt_jx_upload_question_err } from '../actions';
...
const mapDispatchToProps = dispatch => ({
    promise_upload_question_ing: (question) => {
        dispatch(kt_jx_upload_question_ing(question));
    },
    promise_upload_question_done: (data) => {
        dispatch(kt_jx_upload_question_done(data));
    },
    promise_upload_question_err: (err) => {
        dispatch(kt_jx_upload_question_err(err));
    }
})
...
class KTJXPage extends React.Component {
    ...
    upload_question(question) {
        ...
        Axios.post('/api/kt/jixin', { questions: question }, {
            headers: {
