...
import { upload_question_ing, upload_question_done, upload_question_err } from '../actions';
...
const mapDispatchToProps = dispatch => ({
    promise_upload_question_ing: (question) => {
        dispatch(upload_question_ing(question));
    },
    promise_upload_question_done: (data) => {
        dispatch(upload_question_done(data));
    },
    promise_upload_question_err: (err) => {
        dispatch(upload_question_err(err));
    }
})
...
class NninPage extends React.Component {
    ...
    upload_question(question) {
        ...
        Axios.post('/api/nnin', {questions: question}, {
            headers: {
...
export default connect(mapStateToProps, mapDispatchToProps)(NninPage);